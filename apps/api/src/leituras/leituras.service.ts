...
function agruparPorUnidade<T extends { unidadeId: string }>(
  leituras: T[],
): Map<string, T[]> {
 ...
 */
function alertaPara(consumo: number | null, historicos: number[]): AlertaConsumo {
