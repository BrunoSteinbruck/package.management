...
BEGIN
  ...
  FOREACH t IN ARRAY ARRAY['unidades','pacotes','retiradas','notificacoes','vagas','veiculos','avisos','leituras_medidor','tarifas_consumo','comunicados','comunicado_leituras','documentos','despesas','extrato_itens','visitas','integracoes_financeiras','config_financeiro','taxas_unidade','cobrancas','registros_acao']
  LOOP
