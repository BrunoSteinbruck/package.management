...
BEGIN
  ...
  FOREACH t IN ARRAY ARRAY['unidades','pacotes','retiradas','notificacoes','vagas','veiculos','avisos','leituras_medidor','tarifas_consumo','comunicados','comunicado_leituras','documentos']
  LOOP
